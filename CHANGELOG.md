...
### Compact scrollable item grid

- The station window now shows the depot's many slots in a compact, scrollable grid
  (`UI/GridColumns`, `UI/GridVisibleRows`) instead of only the first six.
